...
pub fn for_node(node: &FileNode) -> &'static str {
    match &node.kind {
        ...
        NodeKind::File { extension } => match extension.as_deref() {
            ...
            Some("png" | "jpg" | "jpeg" | "gif" | "svg" | "webp" | "bmp" | "ico" | "tiff") => "◉", // image
            Some("mp3" | "flac" | "ogg" | "wav" | "aac" | "m4a" | "opus") => "♪", // audio
            Some("mp4" | "mkv" | "avi" | "mov" | "webm" | "flv" | "wmv") => "▶",  // video
            Some("pdf" | "doc" | "docx" | "odt" | "rtf" | "epub") => "▤",         // document
            Some("zip" | "tar" | "gz" | "bz2" | "xz" | "7z" | "rar" | "zst") => "◫", // archive
            Some("md" | "txt" | "rst" | "log") => "≡",                            // text
            Some("toml" | "yaml" | "yml" | "json" | "xml" | "ini" | "env") => "◈", // config
