...
- [ ] Recursive search uses LocationRef as the root authority internally.
- [ ] NodeId and path search compatibility inputs translate before traversal.
- [ ] Search result events prefer NodeEntry Location-native output.
- [ ] Compatibility search results remain where existing clients need them and are covered by tests.
