...
This task owns session map lifetime and cursor documentation only. It does not own O(directory) next-page cost under native paging (audit F24); that ceiling is PIPELINE-002.
