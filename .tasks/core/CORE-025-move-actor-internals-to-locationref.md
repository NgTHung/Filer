...
- [ ] ACTORS-001, ACTORS-002, ACTORS-003, ACTORS-004, ACTORS-005, ACTORS-006, and ACTORS-007 are Done.
- [ ] Actor internals use LocationRef as the routing authority before provider work starts.
- [ ] NodeId survives only at explicit compatibility command and event boundaries.
- [ ] Compatibility NodeId behavior and canonical LocationRef behavior are covered by tests.
