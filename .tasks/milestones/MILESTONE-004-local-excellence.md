...
Local file-manager excellence after 0.3.0 contract stabilization. Prove System32-scale browsing and git decoration delivery through public core contracts, measured by a benchmark harness instead of asserted. Core work is CORE-027 audit remediations plus CORE-028 benchmarks.
...
- CORE-027 and children CORE-017, CORE-018, CORE-019, CORE-021, CORE-022, CORE-024
...
- [ ] Location-native paging for large local directories works through public core contracts so a client renders a first page before the walk completes, proven by CORE-028 measurements and contract tests, not app code.
