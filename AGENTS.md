...
This project is indexed by GitNexus as **Filer** (3810 symbols, 10574 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
